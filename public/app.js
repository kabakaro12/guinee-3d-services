...
function openService(k){
 ...
 <div class="service-body">
   ...
   <div class="detail-actions"><button class="primary" onclick="book('${s.form}')">Demander cette intervention</button><a class="secondary" href="tel:+224620242979">Appeler maintenant</a></div>
 </div>`;
 sd.showModal();
}
